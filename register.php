...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $bool = true;
    $query = mysqli_query($conn, "Select * from user_tbl"); // Query the users table
    ...
    if ($bool) {
        mysqli_query($conn, "INSERT INTO user_tbl (username, password) VALUES ('$username','$password')"); // Insert the value to the table users_tbl
